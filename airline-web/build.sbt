...
libraryDependencies ++= Seq(
  ...
  // airline-data is no longer a published artifact fetched by version - the
  // root build.sbt wires it in with dependsOn, so this half compiles against
  // the actual code next door. See the note there for why.
